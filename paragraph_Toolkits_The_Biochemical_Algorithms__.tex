...
Pybel \cite{O_Boyle_2008} provides the full functionality of Open Babel, but common routines are provided in a simplified, more `pythonic' interface.
...
sdsorter provides convenient routines for manipulating the contents of sdf molecular data files based on the embedded sd data tags.
