...
Campari \cite{Vitalis_2009} conducts flexible Monte Carlo sampling of biopolymers in internal coordinate space, with built-in analysis routines for structural properties and support for replica exchange and Wang-Landau sampling.
