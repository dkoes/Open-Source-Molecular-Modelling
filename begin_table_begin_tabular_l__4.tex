...
TexMol & \url{http://cvcweb.ices.utexas.edu/cvcwp/?page_id=1909} & LGPL &  & \cite{Chandrajit_Bajaj} \\
CueMol & \url {http://www.cuemol.org/en/index.php?Download} & GPLv3 ???? For non-profit (academic) organization users &  & \\
QuteMol & \url {http://qutemol.sourceforge.net/} & GPL &  & \cite{Tarini_2006} \\
Jamberoo & \url {https://sourceforge.net/projects/jbonzer/} & GPL/LGPL/Apache2 & & \\
chemkit & \url {https://github.com/kylelutz/chemkit} & BSD & & \\
Dehydron & \url {http://www.pymolwiki.org/index.php/Dehydron} & GPL & & \cite{10.1073/pnas.0501748102} \\
